      ...
      <div className="mx-auto flex max-w-md flex-col gap-4 px-4 pb-16 pt-28">
        ...
        <div className="flex flex-col gap-3 rounded-lg border border-zinc-800 bg-zinc-900/50 p-6">
          <Button
            ...
            className="h-11 justify-center gap-3 border-zinc-700 bg-zinc-950 text-white hover:bg-zinc-900"
            onClick={() => void handleSocialSignIn("github")}
          >
            <GitHubIcon />
            {submittingProvider === "github" ? "Redirecting..." : "Continue with GitHub"}
          </Button>
